...
create table if not exists NAT.original(number int, month string, day string, time string, src_ip string, src_port string, dst_ip string, dst_port string, protocol string, nat_type string, nat_ip string, nat_port string);
create table if not exists SYS.original(number int, month string, day string, year string, time string, hostname string, module string, severity string, program string, message string);
create table if not exists NET.original(time int,bytes string,packets string,src_ip string, dst_ip string, src_port string, dst_port string, protocol string);
