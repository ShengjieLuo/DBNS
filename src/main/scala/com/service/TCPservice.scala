...
class TCPservice() extends Item(){
  ...
  def SS_TCP_UPLOAD_SIZE_SRCIP(key:String,begin:String,end:String){
     var external = new Convertor("SS_TCP_UPLOAD_SIZE_SRCIP",List(key,begin,end))
  ...
  def SA_TCP_UPLOAD_SIZE_SRCIP(begin:String,end:String){ 
     var external = new Convertor("SA_TCP_UPLOAD_SIZE_SRCIP",List(begin,end))
     var internal:List[String] = external.getInterface()
     send_to_queue(internal)  
  }
  ...
  def SA_TCP_UPLOAD_SIZE(begin:String,end:String){ 
     var external = new Convertor("SA_TCP_UPLOAD_SIZE",List(begin,end))
     var internal:List[String] = external.getInterface()
     send_to_queue(internal)  
  }
  ...
  def SS_TCP_DOWNLOAD_SIZE_DSTIP(key:String,begin:String,end:String){
     var external = new Convertor("SS_TCP_DOWNLOAD_SIZE_DSTIP",List(key,begin,end))
     var internal:List[String] = external.getInterface()
     send_to_queue(internal)  
  }
  ...
  def SA_TCP_DOWNLOAD_SIZE_DSTIP(begin:String,end:String){ 
     var external = new Convertor("SA_TCP_DOWNLOAD_SIZE_DSTIP",List(begin,end))
     var internal:List[String] = external.getInterface()
     send_to_queue(internal)  
  }
  ...
  def SA_TCP_DOWNLOAD_SIZE(begin:String,end:String){ 
     var external = new Convertor("SA_TCP_DOWNLOAD_SIZE",List(begin,end))
     var internal:List[String] = external.getInterface()
     send_to_queue(internal)  
  }
  ...
  def SC_TCP_DOWLOAD_UPLOAD_RATIO(key:String,index:String){
     var external = new Convertor("SC_TCP_DOWLOAD_UPLOAD_RATIO",List(key,index))
     var internal:List[String] = external.getInterface()
     send_to_queue(internal)
  }
  ...
  def SC_TCP_DOWLOAD_UPLOAD_ML(key:String,index:String){
     var external = new Convertor("SC_TCP_DOWLOAD_UPLOAD_ML",List(key,index))
     var internal:List[String] = external.getInterface()
     send_to_queue(internal)
  }
