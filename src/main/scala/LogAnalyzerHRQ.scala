...
def main(args:Array[String]){
  ...
  lineMap.saveAsTextFiles("file:///usr/local/spark/mycode/DBNS/backup/hrq.txt")
  ...
  val schema = StructType(List(StructField("time", StringType, true),StructField("TTL", StringType, true),StructField("ips", StringType, true),StructField("ps", StringType, true),StructField("ipd", StringType, true),StructField("pd", StringType, true),StructField("type", StringType, true)))
