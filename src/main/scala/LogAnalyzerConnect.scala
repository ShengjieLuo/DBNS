...
object LogStreamingAdvancedCluster{

def main(args:Array[String]){
  StreamingExamples.setStreamingLogLevels()

  //step0: Receive the information from Kafka
  val sc = new SparkConf().setAppName("LogStreamingAdvancedCluster").setMaster("local[*]")
  ...
  val zkQuorum = "10.255.0.10:2181" //Zookeeper服务器地址
